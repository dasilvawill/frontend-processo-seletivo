      ...
      <div>
        <Disclosure as="nav" className="bg-gray-800">
          {({ open }) => (
            <>
              <div>
                <div className="flex h-[8vh] items-center px-8 justify-between">
              ...
              <div className="flex h-[92vh]">
                <div className="flex-col bg-gray-300 w-[45vw] md:w-[20vw] lg:[15vw]">
                  ...
                  <div className="pt-2 relative mx-auto text-gray-600">
                    ...
                    <button
                      type="submit"
                      className="absolute right-0 top-0 mt-5 mr-24"
                      onClick={() => alert("Aqui seu resultado")}
                    >
                      <svg
                ...
                <div className="flex pt-[30vh] justify-center bg-gray-100 w-[85vw]">
                  <div>
                    <p className="flex items-center justify-center text-6xl pb-8">
                      Seja bem-vindo!
                    </p>
                    <p className="text-xl">
